...
bool Beidou_Cnav2_Navigation_Message::read_navigation_bool(std::bitset<BEIDOU_CNAV2_DATA_BITS> const &bits, const std::vector<std::pair<int, int>> &parameter)
{
    bool value;
...
unsigned long int Beidou_Cnav2_Navigation_Message::read_navigation_unsigned(std::bitset<BEIDOU_CNAV2_DATA_BITS> const &bits, const std::vector<std::pair<int, int>> &parameter)
{
...
signed long int Beidou_Cnav2_Navigation_Message::read_navigation_signed(std::bitset<BEIDOU_CNAV2_DATA_BITS> const &bits, const std::vector<std::pair<int, int>> &parameter)
{
...
int Beidou_Cnav2_Navigation_Message::string_decoder(std::string const &frame_string)
{
    ...
    i_string_mes_type = static_cast<unsigned int>(read_navigation_unsigned(string_bits, MesType));

	// Decode all 8 string messages
	switch (i_string_mes_type)
        {
        case 10:
            //--- It is Type 10 -----------------------------------------------
        	...
        	cnav2_ephemeris.i_BDS_week = static_cast<double>(read_navigation_unsigned(string_bits, WN_10));		//[week] effective range 0~8191
        	...
        	cnav2_ephemeris.dn_0 = static_cast<double>(read_navigation_signed(string_bits, dn_0_10))*BEIDOU_CNAV2_PI*TWO_N44;			//[pi/s]
        	cnav2_ephemeris.dn_0_dot = static_cast<double>(read_navigation_signed(string_bits, dn_0_dot_10))*BEIDOU_CNAV2_PI*TWO_N57;	//[pi/s^2]
        	cnav2_ephemeris.M_0 = static_cast<double>(read_navigation_signed(string_bits, M_0_10))*BEIDOU_CNAV2_PI*TWO_N32;			//[pi]
        	cnav2_ephemeris.e = static_cast<double>(read_navigation_unsigned(string_bits, e_10))*TWO_N34;				//[dimensionless]
        	cnav2_ephemeris.omega = static_cast<double>(read_navigation_signed(string_bits, omega_10))*BEIDOU_CNAV2_PI*TWO_N32;		//[pi]
        	// Ephemeris I End
        ...
        case 11:
			...
			// Ephemeris II Start
			cnav2_ephemeris.Omega_0 = static_cast<double>(read_navigation_signed(string_bits, Omega_0_11))*BEIDOU_CNAV2_PI*TWO_N32;		//[pi]
			cnav2_ephemeris.i_0 = static_cast<double>(read_navigation_signed(string_bits, i_0_11))*BEIDOU_CNAV2_PI*TWO_N32;				//[pi]
			cnav2_ephemeris.Omega_dot = static_cast<double>(read_navigation_signed(string_bits, Omega_dot_11))*BEIDOU_CNAV2_PI*TWO_N44;	//[pi/s]
			cnav2_ephemeris.i_0_dot = static_cast<double>(read_navigation_signed(string_bits, i_0_dot_11))*BEIDOU_CNAV2_PI*TWO_N44;		//[pi/s]
        ...
        case 30:
        	...
        	cnav2_iono.alpha1 = static_cast<double>(read_navigation_unsigned(string_bits, alpha_1_30))*TWO_N3;		//[TECu]
        	cnav2_iono.alpha2 = static_cast<double>(read_navigation_signed(string_bits, alpha_2_30))*TWO_N3;			//[TECu]
        	cnav2_iono.alpha3 = static_cast<double>(read_navigation_unsigned(string_bits, alpha_3_30))*TWO_N3;		//[TECu]
        	cnav2_iono.alpha4 = static_cast<double>(read_navigation_unsigned(string_bits, alpha_4_30))*TWO_N3;		//[TECu]
        	cnav2_iono.alpha5 = static_cast<double>(read_navigation_unsigned(string_bits, alpha_5_30))*TWO_N3*(-1);	//[TECu]
        	cnav2_iono.alpha6 = static_cast<double>(read_navigation_signed(string_bits, alpha_6_30))*TWO_N3;			//[TECu]
        	cnav2_iono.alpha7 = static_cast<double>(read_navigation_signed(string_bits, alpha_7_30))*TWO_N3;			//[TECu]
        	cnav2_iono.alpha8 = static_cast<double>(read_navigation_signed(string_bits, alpha_8_30))*TWO_N3;			//[TECu]
        	cnav2_iono.alpha9 = static_cast<double>(read_navigation_signed(string_bits, alpha_9_30))*TWO_N3;			//[TECu]
        ...
        case 31:
			...
			// Clock Correction Parameters (69 bits)
			cnav2_ephemeris.t_oc = static_cast<double>(read_navigation_unsigned(string_bits, t_oc_31))*300; //[s]
			cnav2_ephemeris.a_0 = static_cast<double>(read_navigation_signed(string_bits, a_0_31))*TWO_N34; //[s]
			cnav2_ephemeris.a_1 = static_cast<double>(read_navigation_signed(string_bits, a_1_31))*TWO_N50; //[s/s]
			cnav2_ephemeris.a_2 = static_cast<double>(read_navigation_signed(string_bits, a_2_31))*TWO_N66; //[s/s^2]
			...
			cnav2_almanac[i_alm_satellite_PRN-1].i_BDS_week = static_cast<int>(read_navigation_unsigned(string_bits, WN_a_31));				//[week] effective range 0~8191
			...
			cnav2_almanac[i_alm_satellite_PRN-1].Omega_0 = static_cast<double>(read_navigation_signed(string_bits, Omega_01_31))*BEIDOU_CNAV2_PI*TWO_N6;	//[pi]
			cnav2_almanac[i_alm_satellite_PRN-1].Phi_0 = static_cast<double>(read_navigation_signed(string_bits, Phi_01_31))*BEIDOU_CNAV2_PI*TWO_N6;		//[pi] Phi = M0 + omega, e=0, delta_i=0, MEO/IGSO i=55, GEO i=0
			...
			cnav2_almanac[i_alm_satellite_PRN-1].Omega_0 = static_cast<double>(read_navigation_signed(string_bits, Omega_02_31))*BEIDOU_CNAV2_PI*TWO_N6;	//[pi]
			cnav2_almanac[i_alm_satellite_PRN-1].Phi_0 = static_cast<double>(read_navigation_signed(string_bits, Phi_02_31))*BEIDOU_CNAV2_PI*TWO_N6;		//[pi] Phi = M0 + omega, e=0, delta_i=0, MEO/IGSO i=55, GEO i=0
			...
			cnav2_almanac[i_alm_satellite_PRN-1].Omega_0 = static_cast<double>(read_navigation_signed(string_bits, Omega_03_31))*BEIDOU_CNAV2_PI*TWO_N6;	//[pi]
			cnav2_almanac[i_alm_satellite_PRN-1].Phi_0 = static_cast<double>(read_navigation_signed(string_bits, Phi_03_31))*BEIDOU_CNAV2_PI*TWO_N6;		//[pi] Phi = M0 + omega, e=0, delta_i=0, MEO/IGSO i=55, GEO i=0
        ...
        case 32:
        	...
        	// Clock Correction Parameters (69 bits)
			cnav2_ephemeris.t_oc = static_cast<double>(read_navigation_unsigned(string_bits, t_oc_32))*300; //[s]
			cnav2_ephemeris.a_0 = static_cast<double>(read_navigation_signed(string_bits, a_0_32))*TWO_N34; //[s]
			cnav2_ephemeris.a_1 = static_cast<double>(read_navigation_signed(string_bits, a_1_32))*TWO_N50; //[s/s]
			cnav2_ephemeris.a_2 = static_cast<double>(read_navigation_signed(string_bits, a_2_32))*TWO_N66; //[s/s^2]
        ...
        case 33:
        	...
        	// Clock Correction Parameters (69 bits)
			cnav2_ephemeris.t_oc = static_cast<double>(read_navigation_unsigned(string_bits, t_oc_33))*300; //[s]
			cnav2_ephemeris.a_0 = static_cast<double>(read_navigation_signed(string_bits, a_0_33))*TWO_N34; //[s]
			cnav2_ephemeris.a_1 = static_cast<double>(read_navigation_signed(string_bits, a_1_33))*TWO_N50; //[s/s]
			cnav2_ephemeris.a_2 = static_cast<double>(read_navigation_signed(string_bits, a_2_33))*TWO_N66; //[s/s^2]
        	// Clock Correction Parameters End
			...
			cnav2_almanac[i_alm_satellite_PRN-1].Omega_0 = static_cast<double>(read_navigation_signed(string_bits, Omega_0_33))*BEIDOU_CNAV2_PI*TWO_N6;	//[pi]
			cnav2_almanac[i_alm_satellite_PRN-1].Phi_0 = static_cast<double>(read_navigation_signed(string_bits, Phi_0_33))*BEIDOU_CNAV2_PI*TWO_N6;		//[pi] Phi = M0 + omega, e=0, delta_i=0, MEO/IGSO i=55, GEO i=0
			...
			cnav2_almanac[i_alm_satellite_PRN-1].i_BDS_week = static_cast<int>(read_navigation_unsigned(string_bits, WN_ALM_33));			//[week] effective range 0~8191
        ...
        case 34:
        	...
        	// Clock Correction Parameters (69 bits)
			cnav2_ephemeris.t_oc = static_cast<double>(read_navigation_unsigned(string_bits, t_oc_34))*300; 		//[s]
			cnav2_ephemeris.a_0 = static_cast<double>(read_navigation_signed(string_bits, a_0_34))*TWO_N34; 		//[s]
			cnav2_ephemeris.a_1 = static_cast<double>(read_navigation_signed(string_bits, a_1_34))*TWO_N50; 		//[s/s]
			cnav2_ephemeris.a_2 = static_cast<double>(read_navigation_signed(string_bits, a_2_34))*TWO_N66; 		//[s/s^2]
        	// Clock Correction Parameters End
        ...
        case 40:
        	...
        	cnav2_almanac[i_alm_satellite_PRN-1].i_BDS_week = static_cast<int>(read_navigation_unsigned(string_bits, WN_a_40));					//[week] effective range 0~8191
        	...
        	cnav2_almanac[i_alm_satellite_PRN-1].delta_i = static_cast<double>(read_navigation_signed(string_bits, delta_i_40))*BEIDOU_CNAV2_PI*TWO_N14;		//[pi]
        	...
        	cnav2_almanac[i_alm_satellite_PRN-1].Omega_0 = static_cast<double>(read_navigation_signed(string_bits, Omega_0_40))*BEIDOU_CNAV2_PI*TWO_N15;		//[pi]
        	cnav2_almanac[i_alm_satellite_PRN-1].Omega_dot = static_cast<double>(read_navigation_signed(string_bits, Omega_dot_40))*BEIDOU_CNAV2_PI*TWO_N33;	//[pi/s]
        	cnav2_almanac[i_alm_satellite_PRN-1].omega = static_cast<double>(read_navigation_signed(string_bits, omega_40))*BEIDOU_CNAV2_PI*TWO_N15;			//[pi]
        	cnav2_almanac[i_alm_satellite_PRN-1].M_0 = static_cast<double>(read_navigation_signed(string_bits, M_0_40))*BEIDOU_CNAV2_PI*TWO_N15;				//[pi]
        ...
        default:
            LOG(INFO) << "BEIDOU CNAV2: Invalid String ID of received. Received " << i_string_mes_type
                      << ", but acceptable range is from 10 11 30 31 32 33 34 40";

            break;
        }  // switch string ID

    return i_string_mes_type;
}
