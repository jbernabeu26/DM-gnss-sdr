...
#ifndef GNSS_SDR_BEIDOU_B1c_H_
#define GNSS_SDR_BEIDOU_B1c_H_
...
//!<Beidou B1c secondary codes. Data component do not heave secondary code. Pilot component have secondary codes which are generated by truncating Weil Codes. 
const int32_t BEIDOU_B1cp_SECONDARY_CODE_LENGTH_CHIPS = 1800;  // Each secondary code of Pilot component has the length 1800 chips.


const int32_t WEIL_N = 10243;
const int32_t WEIL_N_SECONDARY = 3607;
