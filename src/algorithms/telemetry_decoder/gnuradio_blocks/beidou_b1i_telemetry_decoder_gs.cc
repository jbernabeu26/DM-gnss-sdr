    ...
    if (d_nav.have_new_ephemeris() == true)
        {
            ...
            std::cout << TEXT_MAGENTA << "New BEIDOU B1I DNAV message received in channel " << d_channel << ": ephemeris from satellite " << d_satellite << TEXT_RESET << std::endl;
        }
    if (d_nav.have_new_utc_model() == true)
        {
            ...
            std::cout << TEXT_MAGENTA << "New BEIDOU B1I DNAV utc model message received in channel " << d_channel << ": UTC model parameters from satellite " << d_satellite << TEXT_RESET << std::endl;
        }
    if (d_nav.have_new_iono() == true)
        {
            ...
            std::cout << TEXT_MAGENTA << "New BEIDOU B1I DNAV Iono message received in channel " << d_channel << ": Iono model parameters from satellite " << d_satellite << TEXT_RESET << std::endl;
        }
    if (d_nav.have_new_almanac() == true)
        {
            ...
            std::cout << TEXT_MAGENTA << "New BEIDOU B1I DNAV almanac received in channel " << d_channel << " from satellite " << d_satellite << TEXT_RESET << std::endl;
        }
}
