    ...
    try
        {
            ...
            // **************** BeiDou telemetry ********************
            else if (pmt::any_ref(msg).type() == typeid(std::shared_ptr<Beidou_Cnav2_Ephemeris>))
                {
                    ...
                    // update/insert new ephemeris record to the global ephemeris map
                    d_pvt_solver->beidou_cnav2_ephemeris_map[beidou_cnav2_eph->i_satellite_PRN] = *beidou_cnav2_eph;
                }
            else if (pmt::any_ref(msg).type() == typeid(std::shared_ptr<Beidou_Cnav2_Iono>))
                {
                    ...
                    d_pvt_solver->beidou_cnav2_iono = *beidou_cnav2_iono;
            ...
            else if (pmt::any_ref(msg).type() == typeid(std::shared_ptr<Beidou_Cnav2_Utc_Model>))
                {
                    ...
                    d_pvt_solver->beidou_cnav2_utc_model = *beidou_cnav2_utc_model;
            ...
            else if (pmt::any_ref(msg).type() == typeid(std::shared_ptr<Beidou_Cnav2_Almanac>))
                {
                    ...
                    // update/insert new almanac record to the global almanac map
                    d_pvt_solver->beidou_cnav2_almanac_map[beidou_cnav2_alm->i_satellite_PRN] = *beidou_cnav2_alm;
    ...
    if (d_xml_storage)
        {
                    ...
                    try
                        {
                            ofs.open(file_name.c_str(), std::ofstream::trunc | std::ofstream::out);
                            boost::archive::xml_oarchive xml(ofs);
                            xml << boost::serialization::make_nvp("GNSS-SDR_beidou_cnav2_ephemeris_map", d_pvt_solver->beidou_cnav2_ephemeris_map);
                    ...
                    try
                        {
                            ofs.open(file_name.c_str(), std::ofstream::trunc | std::ofstream::out);
                            boost::archive::xml_oarchive xml(ofs);
                            xml << boost::serialization::make_nvp("GNSS-SDR_beidou_cnav2_utc_model", d_pvt_solver->beidou_cnav2_utc_model);
            ...
            if (d_pvt_solver->beidou_cnav2_iono.d_flag_valid == true)
                {
                    std::ofstream ofs;
                    try
                        {
                            ofs.open(file_name.c_str(), std::ofstream::trunc | std::ofstream::out);
                            boost::archive::xml_oarchive xml(ofs);
                            xml << boost::serialization::make_nvp("GNSS-SDR_beidou_cnav2_iono_model", d_pvt_solver->beidou_cnav2_iono);
					...
					try
						{
							ofs.open(file_name.c_str(), std::ofstream::trunc | std::ofstream::out);
							boost::archive::xml_oarchive xml(ofs);
							xml << boost::serialization::make_nvp("GNSS-SDR_beidou_cnav2_almanac_map", d_pvt_solver->beidou_cnav2_almanac_map);
