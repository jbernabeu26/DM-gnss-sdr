...
class BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx;

typedef boost::shared_ptr<BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx> BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_sptr;

BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_sptr BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_make(concurrent_queue<int>& queue);


class BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx : public gr::block
{
private:
    friend BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_sptr BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_make(concurrent_queue<int>& queue);
    void msg_handler_events(pmt::pmt_t msg);
    BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx(concurrent_queue<int>& queue);
    concurrent_queue<int>& channel_internal_queue;

public:
    int rx_message;
    ~BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx();  //!< Default destructor
};


BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_sptr BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_make(concurrent_queue<int>& queue)
{
    return BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_sptr(new BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx(queue));
}


void BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx::msg_handler_events(pmt::pmt_t msg)
{
    try
        {
...
BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx::~BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx()
{
}
...
class BeidouB2adPcpsAcquisitionGSoC2018Test : public ::testing::Test
{
protected:
	BeidouB2adPcpsAcquisitionGSoC2018Test()
    {
    ...
    BeidouB2adPcpsAcquisition* acquisition;
...
void BeidouB2adPcpsAcquisitionGSoC2018Test::init()
{
    message = 0;
...
void BeidouB2adAcquisitionGSoC2018Test::config_1()
{
...
void BeidouB2adPcpsAcquisitionGSoC2018Test::config_2()
{
    gnss_synchro.Channel_ID = 0;
    gnss_synchro.System = 'C';
    std::string signal = "5C";
    ...
    expected_delay_chips = 18718;//todo sara fix this value
    expected_doppler_hz = 410;//todo sara fix this value
    ...
    config->set_property("SignalSource.PRN_1", "15");//todo sara fix this value
    config->set_property("SignalSource.CN0_dB_1", "44");//todo sara fix this value
    config->set_property("SignalSource.doppler_Hz_1", "1000");//todo sara fix this value
    config->set_property("SignalSource.delay_chips_1", "100");

    config->set_property("SignalSource.system_2", "C");
    config->set_property("SignalSource.PRN_2", "21");//todo sara fix this value
    config->set_property("SignalSource.CN0_dB_2", "44");//todo sara fix this value
    config->set_property("SignalSource.doppler_Hz_2", "2000");//todo sara fix this value
    config->set_property("SignalSource.delay_chips_2", "200");//todo sara fix this value
...
void BeidouB2adPcpsAcquisitionGSoC2018Test::start_queue()
{
    stop = false;
    ch_thread = boost::thread(&BeidouB2adPcpsAcquisitionGSoC2018Test::wait_message, this);
}


void BeidouB2adPcpsAcquisitionGSoC2018Test::wait_message()
{
    struct timeval tv;
...
void BeidouB2adPcpsAcquisitionGSoC2018Test::process_message()
{
    if (message == 1)
        {
            detection_counter++;
...
void BeidouB2adPcpsAcquisitionGSoC2018Test::stop_queue()
{
    stop = true;
}


TEST_F(BeidouB2adPcpsAcquisitionGSoC2018Test, Instantiate)
{
    config_1();
    acquisition = new BeidouB2adPcpsAcquisition(config.get(), "Acquisition", 1, 1);
    delete acquisition;
}


TEST_F(BeidouB2adPcpsAcquisitionGSoC2018Test, ConnectAndRun)
{
    ...
    config_1();
    acquisition = new BeidouB2adPcpsAcquisition(config.get(), "Acquisition", 1, 1);
    boost::shared_ptr<BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx> msg_rx = BeidouB2adPcpsAcquisitionGSoC2018Test_msg_rx_make(channel_internal_queue);
...
TEST_F(BeidouB2adPcpsAcquisitionGSoC2018Test, ValidationOfResults)
{
    config_1();
    queue = gr::msg_queue::make(0);
    top_block = gr::make_top_block("Acquisition test");
    ...
    for (unsigned int i = 0; i < 2; i++)
        {
            ...
            if (i == 0)
                {
                    gnss_synchro.PRN = 27;  // This satellite is visible//todo sara double check
                }
            else if (i == 1)
                {
                    gnss_synchro.PRN = 19;  // This satellite is not visible//todo sara double check
                }
...
TEST_F(BeidouB2adPcpsAcquisitionGSoC2018Test, ValidationOfResultsProbabilities)
{
    config_2();
    queue = gr::msg_queue::make(0);
    top_block = gr::make_top_block("Acquisition test");
